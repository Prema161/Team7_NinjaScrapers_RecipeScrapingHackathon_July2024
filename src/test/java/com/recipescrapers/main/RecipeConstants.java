...
public class RecipeConstants {
   ...
   // public static final String LFV_RECIPES_TO_AVOID = "fried food,microwave meals or ready meals,Chips,crackers";
    ...
    public static final String LCHF_FOOD_PROCESSING = "Raw,steamed,Boiled,Porched,Sauted,Airfryed,Pan fried";
	...
	public static String[] LFV_RECIPES_TO_AVOID = new String[] {"fried", "microwave", "ready made","ready","chips","crackers","fritters"};
	public static final String[] RECIPE_CATEGORY_OPTIONS = {"breakfast" ,"lunch","snack", "dinner"};
	public static String CUISIN_CATEGORY ="Indian,SouthIndian,Rajathani,Punjabi,Bengali,Orissa,Gujarathi,"
	...
	public static final String LFV_NUT_ALLERGY = "Peanuts,walnut,almond,hazelnut,pecan,cashew,pistachio";
    public static final String LFV_OTHER_ALLERGY="soy,sesame,egg";
    
	public static final String LFV_OPTONAL_RECIPES_OPTIONS = "herbal,herbal drinks,coffe,tea,herbal drink";
	public static final String LFV_OPTONAL_RECIPES__TO_AVOID = "milk,sugar"; 
	public static final String LFV_OPTONAL_RECIPES__TO_ELIMINATE= "snack,snacks"; 
